...
expFile="crgGeneExp.txt"      #表达数据文件
setwd("C://Users//41939//Desktop//大创项目文件夹//子宫内膜异位症//Reanalysis_GSE51981//07.diff")      #设置工作目录
...
pheatmap(data,
         annotation=Type,
         color = colorRampPalette(c(rep("#8BACD1",2), "white", rep("#C17F9E",2)))(100),
         cluster_cols =F,
         cluster_rows =T,
         scale="row",
         show_colnames=F,
...
#输出箱线图
pdf(file="boxplot.pdf", width=13.5, height=7)
print(p1)
dev.off()
